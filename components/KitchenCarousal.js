...
const KitchenCarousal = () => {
    ...
    return (
       <div> 
        ...
        <div className={`shadow shadow-black rounded ${repur===0 ? `overflow-x-scroll w-[75vw] 
       border-x-[1.6rem] border-white bg-white lg:overflow-x-hidden lg:hover:overflow-x-scroll` : `overflow-x-hidden w-[75vw] 
